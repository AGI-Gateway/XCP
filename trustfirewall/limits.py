...
COST: dict[str, int] = {
    ...
    # Peering and gossip are unauthenticated by necessity — a peer has to be
    # able to introduce itself before any relationship exists. Charging them at
    # tool-call rates means a node with more than a handful of peers throttles
    # its own federation. They are cheap to serve, so they are charged cheaply
    # and, in the gateway, metered under a separate key.
    "federation": 1,
    "_default": 5,
}
